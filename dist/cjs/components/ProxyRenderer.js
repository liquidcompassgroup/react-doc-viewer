...
var ProxyRenderer = function () {
    ...
    return (react_1.default.createElement(Container, { id: "proxy-renderer", "data-testid": "proxy-renderer", ref: containerRef },
        react_1.default.createElement(Contents, { state: state, documents: documents, documentLoading: documentLoading, config: config, currentDocument: currentDocument, fileName: fileName, CurrentRenderer: CurrentRenderer, t: t })));
};
