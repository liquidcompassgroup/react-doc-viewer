...
var PDFPages = function () {
    ...
    var options = (0, react_1.useMemo)(function () { return ({
        cMapUrl: "https://cdn.jsdelivr.net/npm/pdfjs-dist@".concat(react_pdf_1.pdfjs.version, "/cmaps/"),
        cMapPacked: true,
    }); }, []);
    ...
    return (react_1.default.createElement(DocumentPDF, { file: currentDocument.fileData, onLoadSuccess: function (_a) {
        ...
        }, loading: react_1.default.createElement("span", null, t("pdfPluginLoading")), options: options }, paginated ? react_1.default.createElement(PDFSinglePage_1.default, null) : react_1.default.createElement(PDFAllPages_1.PDFAllPages, null)));
};
