...
var PDFPages = function () {
    ...
    var options = useMemo(function () { return ({
        cMapUrl: "https://cdn.jsdelivr.net/npm/pdfjs-dist@".concat(pdfjs.version, "/cmaps/"),
        cMapPacked: true,
    }); }, []);
    useEffect(function () {
    ...
    return (React.createElement(DocumentPDF, { file: currentDocument.fileData, onLoadSuccess: function (_a) {
        ...
        }, loading: React.createElement("span", null, t("pdfPluginLoading")), options: options }, paginated ? React.createElement(PDFSinglePage, null) : React.createElement(PDFAllPages, null)));
};
